      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        >
          <svg viewBox="0 0 400 160" preserveAspectRatio="none" className="w-full h-full">
            <path d="M 0 50 Q 50 28 100 50 Q 150 72 200 50 Q 250 28 300 50 Q 350 72 400 50 L 400 160 L 0 160 Z" fill="#90ccc8" opacity="0.45" />
            <path d="M 0 72 Q 60 52 120 72 Q 180 92 240 72 Q 300 52 360 72 L 400 80 L 400 160 L 0 160 Z" fill="#78c4c0" opacity="0.35" />
          </svg>
        </motion.div>
        ...
        <div className="absolute inset-0 flex items-end justify-center" style={{ paddingBottom: '12%' }}>
          <motion.div style={{ x: brideX, scale: charScale }} className="absolute w-[108px] origin-bottom">
            <BrideSVG />
          </motion.div>
          <motion.div style={{ x: groomX, scale: charScale }} className="absolute w-[108px] origin-bottom">
            <GroomSVG />
          </motion.div>
        </div>
        <motion.div
        ...
        >
          <p className="text-[8px] tracking-[0.45em] text-[#b8a89c] uppercase">scroll down</p>
        </motion.div>
      </div>
    </div>
  )
...
function WeddingInfoSection() {
  return (
    <section className="min-h-screen bg-[#f8f4ee] flex flex-col items-center justify-center px-8 py-28">
      ...
      >
        <p className="text-[9px] tracking-[0.55em] text-[#c4956a] uppercase mb-14">Wedding Day</p>
        <div className="space-y-11">
          <div>
            <p className="text-[8px] tracking-[0.4em] text-[#c0b0a8] mb-3">DATE</p>
            <p className="font-serif text-[#3a3530] text-[1.9rem] font-light tracking-wider leading-none">2026. 06. 14</p>
            <p className="text-[12px] text-[#9a8a80] mt-2 tracking-[0.25em] font-light">일요일</p>
          </div>
          <div className="w-6 h-px bg-[#d4b896] mx-auto opacity-70" />
          <div>
            <p className="text-[8px] tracking-[0.4em] text-[#c0b0a8] mb-3">TIME</p>
            <p className="font-serif text-[#3a3530] text-[1.9rem] font-light tracking-wider leading-none">오후 1:00</p>
          </div>
          <div className="w-6 h-px bg-[#d4b896] mx-auto opacity-70" />
          <div>
            <p className="text-[8px] tracking-[0.4em] text-[#c0b0a8] mb-3">VENUE</p>
            <p className="font-serif text-[#3a3530] text-[1.4rem] font-light tracking-wide">카페 브리지</p>
            <p className="text-[11px] text-[#9a8a80] mt-3 leading-relaxed font-light tracking-wide">서울특별시 마포구 와우산로 21</p>
          </div>
        </div>
        <div className="mt-20 pt-10 border-t border-[#e8ddd0]">
          <p className="font-serif text-[#c4956a] text-[0.95rem] font-light italic">Gildong &amp; Younghee</p>
          <p className="text-[8px] tracking-[0.38em] text-[#c8b8ae] mt-2">2026 · 06 · 14</p>
        </div>
      </motion.div>
    </section>
  )
